...
| `guide:addressesHazard` | 직접 위험 대응 (Guide) | guide:KoshaGuide | haz:Hazard |
...
| `risk:correspondsToHazard` | 위험 유형 대응 | risk:RiskFeature | haz:Hazard |
...
| `sr:addressesHazard` | 대응 위험 | sr:SafetyRequirement | haz:Hazard |
