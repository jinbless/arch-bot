...
_E = [
    ...
    ("facet-axis-disjoint", "kosha-facet-axis-disjoint.ttl", "axioms-disjoint", "L3-reasoning",
     {"SRV", "CON", "MAT", "FAC"}, "turtle", "facet 9축 상호 disjoint (B3a/F2; B3a 정정으로 haz:Hazard 제외). risk:RiskFeature children."),
    ("hazard-axis-taxonomy", "kosha-hazard-axis-taxonomy.ttl", "axioms-taxonomy", "L3-reasoning",
     {"SRV", "CON", "MAT", "FAC"}, "turtle", "B5/F4: haz:AccidentType ⊑ haz:Hazard (haz:Hazard 빈 축 재정의). facet-axis-disjoint 짝."),
