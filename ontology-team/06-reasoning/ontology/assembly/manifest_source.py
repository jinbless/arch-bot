...
_E = [
    ...
    ("abox-she-l2tune", "kosha-instances-she-l2tune.ttl", "abox-derived", "L3-reasoning",
     {"SRV", "CON", "MAT", "FAC"}, "turtle",
     "OWA→CWA L2 보강 37 SHE 패턴 ABox (PG she_catalog marker owacwa-*-20260608, SR 보정 반영). 생성: data-team/04-ontology-export/export-scripts/export_she_catalog_to_abox.py."),
