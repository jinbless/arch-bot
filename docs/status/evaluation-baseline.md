...
## 앵커(기인물) 인식 정확도 — 시간축 구조의 단일 실패점 (2026-08-01, 좌표 버그 수정 후 ⭐)
...
| 지표 | 값 | CI95 |
|---|---|---|
| 관 단위 정확 일치 | **0.711** | [0.578, 0.844] |
| 절 단위 일치(상위 흐름 공유) | **0.733** | [0.600, 0.844] |
| 완전 오인식(절도 불일치) | **26.7%** (12/45) | |
| 예측 자체가 빈 사진 | 1장 | |
...
**caveat**: gold 129장 중 **45장만 채점**된다(나머지 84장은 정답 조문이 총칙뿐이라 기인물 축으로 역산 불가).
gold가 감독건 인용이라 사진의 모든 기인물을 담지 않으므로 recall은 과소평가된다.
