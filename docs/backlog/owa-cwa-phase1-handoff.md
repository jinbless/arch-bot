...
## 커밋 (`fd61575` → `b44aad9`)
`fd61575` plan · `d775f4b` **P1 C묶음(GATE-4~8)** · `b44aad9` **P1 EVAL-1** · `ba23bac` handoff · `c72e89a` **P1 GATE-2** · (+baseline v4-alive 정정). (중간: f1650d5/5267db6/8f5f281 P0 · 4ee687d OBS-1 · 13ea7b2 SAFETY-5 · a1e1e0e/3813ded/dea6987 baseline·handoff)
