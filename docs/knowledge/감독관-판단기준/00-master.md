...
- 난간 있고 구조 충족 → 위반 없음.
- **동일 패턴 일반화**: 제43조(개구부)·제56조(비계)·제68조(이동식비계 최상부)·**제45조(지붕 가장자리 — 조문이 "제13조에 따른 안전난간"을 명시 준용)**도 — 난간 **없음**=그 장소조문(미설치), 난간 **있으나 구조미달**=제13조.
...
- **제42조**: 작업발판(1차) → (설치곤란) 추락방호망(2차) → (곤란) 안전대(3차) → **제44조**(안전대 부착설비·작업 전 점검). (④ 발판·방호망 곤란시 이동식 사다리 작업 허용 — 3.5m↓·버팀대 3개↑·안전모+안전대 등 요건부.)
- **제43조**: 난간등·덮개(1차) → (곤란·임시해체) 제42조 추락방호망 → 안전대 → 제44조.
- **제45조(지붕)**: 가장자리 안전난간(1차, 구조=제13조 준용) → (곤란) 제42조② 기준 추락방호망 → (곤란) 안전대 → 제44조. ★채광창 견고한 덮개·슬레이트 등 약한 지붕 폭30cm 발판은 **대체 불가 독립 의무**(난간 체인과 별개).
...
| 추락-지붕 | **제45조**(①가장자리 난간 ②채광창 덮개 ③슬레이트 발판30cm) | 난간 구조미달 +제13조 / 난간 곤란시 제42조② 방호망→제44조 |
