...
The accepted runtime baseline is `ci_preferred_guide_ci1`. Runtime still reads PostgreSQL and OHS JSON artifacts, but the following files are exported for machine validation:
...
pictures-json/reports/pipeline_quality_v1_v10_ci_preferred_guide_ci1.json
...
```text
koshaontology/ontology/serving-validation-report-ci_preferred_guide_ci1.json
koshaontology/ontology/serving-validation-report-ci_preferred_guide_ci1.md
koshaontology/ontology/serving-validation-report-ci_preferred_guide_ci1.csv
koshaontology/ontology/serving-workprocess-alignment-ci_preferred_guide_ci1.json
koshaontology/ontology/serving-workprocess-alignment-ci_preferred_guide_ci1.md
koshaontology/ontology/serving-workprocess-alignment-ci_preferred_guide_ci1.csv
```
...
The serving snapshot follows the same rule. OHS does not query `serving-snapshot-ci_preferred_guide_ci1.ttl` in the request path; the snapshot is regenerated from serving artifacts and reports whenever a new accepted baseline is created.
