...
REPORT_JSON_PATH = ONTOLOGY_DIR / "serving-validation-report-corpus_gap_guard1.json"
REPORT_MD_PATH = ONTOLOGY_DIR / "serving-validation-report-corpus_gap_guard1.md"
REPORT_CSV_PATH = ONTOLOGY_DIR / "serving-validation-report-corpus_gap_guard1.csv"
